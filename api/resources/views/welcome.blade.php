                      ...
                      <div  class="col-sm-12">
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <a ng-repeat="item in products" class="dropdown-item" href="" ng-click="loadproduct(item.casePrice,item.colorFrontImage,item.colorBackImage,item.colorSideImage,item.colorName,item.sizeName)"><img style="width: 15%" src="https://www.ssactivewear.com/@{{item.colorSwatchImage}}">@{{item.colorName}} - @{{item.sizeName}} </a>
                          </div>
                        </div>
                      </div>
                    </div>
